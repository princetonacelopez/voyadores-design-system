    ...
    return ( () => {
        ...
        return ( () => {
            ...
            let h = {
                ...
                inputEventName: l ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input",
            ...
            let y = {
                ...
                clusterBy: function(t, e) {
                    var n;
                    return t.length ? g(t).reduce(function(t, n) {
                        var o = m(t);
                        return e(m(o), n) ? o[o.length] = n : t[t.length] = [n],
                        t
                    }, [[(n = t)[0]]]) : []
                },
                compact: function(t) {
            ...
            var S = C("PRE")
              ...
              , N = C("DATA");
            function I(t) {
                return !(A(t) || P(t) || _(t) || $(t) || E(t) || L(t) || N(t))
            }
            function P(t) {
            ...
            var F = C("A")
              , D = C("BODY")
              , H = h.isMSIE && h.browserVersion < 11 ? "&nbsp;" : "<br>";
            function z(t) {
                return w(t) ? t.nodeValue.length : t ? t.childNodes.length : 0
            }
            function B(t) {
                var e = z(t);
                return 0 === e || !w(t) && 1 === e && t.innerHTML === H || !(!y.all(t.childNodes, w) || "" !== t.innerHTML)
            }
            function M(t) {
                x(t) || z(t) || (t.innerHTML = H)
            }
            function O(t, e) {
                for (; t; ) {
                    if (e(t))
            ...
            function J(t, e) {
                ...
                if (0 === t.offset) {
                    ...
                    X(t.node) ? o = z(n = t.node.childNodes[t.offset - 1]) : (n = t.node,
                    o = e ? 0 : t.offset - 1);
                return {
                    node: n,
                    offset: o
            ...
            function tt(t, e) {
                var n, o;
                if (z(t.node) === t.offset) {
                    if (k(t.node))
                        return null;
                    var i = function t(e) {
                        if (e.nextSibling && e.parent === e.nextSibling.parent)
                            return w(e.nextSibling) ? e.nextSibling : t(e.nextSibling)
                    }(t.node);
                    i ? (n = i,
                    o = 0) : (n = t.node.parentNode,
                    o = Q(t.node) + 1)
                } else
                    X(t.node) ? (n = t.node.childNodes[t.offset],
                    o = 0) : (n = t.node,
                    o = e ? z(t.node) : t.offset + 1);
                return {
                    node: n,
                    offset: o
                }
            ...
            function te(t, e) {
                ...
                if (z(t.node) === t.offset) {
                    ...
                    n = t.node.parentNode,
                    o = Q(t.node) + 1,
                    k(n) && (n = t.node.nextSibling,
                    o = 0)
                } else if (X(t.node)) {
                    if (o = 0,
                    B(n = t.node.childNodes[t.offset]))
                        return B(t.node.nextSibling) ? null : {
            ...
            function to(t, e) {
                ...
                var r = t.node.childNodes[t.offset]
                  , a = j(t.node.cloneNode(!1), t.node);
                return K(a, W(r)),
                n || (M(t.node),
                M(a)),
                i && (B(t.node) && ta(t.node),
                B(a)) ? (ta(a),
                t.node.nextSibling) : a
            }
            function ti(t, e, n) {
                var o = U(e.node, p.eq(t));
                return o.length ? 1 === o.length ? to(e, n) : o.reduce(function(t, o) {
                    return t === e.node && (t = to(e, n)),
                    to({
                        node: o,
                        offset: t ? Q(t) : z(o)
                    }, n)
            ...
            let tc = {
                ...
                isLeftEdgePointOf: function(t, e) {
                    return V(t) && Y(t.node, e)
                },
                isRightEdgePointOf: function(t, e) {
                    return q(t) && Z(t.node, e)
                },
                prevPoint: J,
                nextPoint: tt,
                nextPointWithEmptyNode: te,
                isSamePoint: tn,
                isVisiblePoint: function(t) {
                    if (w(t.node) || !X(t.node) || B(t.node))
                        return !0;
                    var e = t.node.childNodes[t.offset - 1]
                      , n = t.node.childNodes[t.offset];
                    return !((e && !x(e) || n && !x(n)) && !E(n))
                },
                ...
                walkPoint: function(t, e, n, o) {
                    for (var i = t; i && (n(i),
                    !tn(i, e)); )
                        i = te(i, o && t.node !== i.node && e.node !== i.node)
                },
                ancestor: O,
                singleChildAncestor: function(t, e) {
                    for (t = t.parentNode; t && 1 === z(t); ) {
                        if (e(t))
                            return t;
                        if (k(t))
                            break;
                ...
                commonAncestor: function(t, e) {
                    for (var n = U(t), o = e; o; o = o.parentNode)
                        if (n.indexOf(o) > -1)
                            return o;
                    return null
                },
                ...
                makeOffsetPath: function(t, e) {
                    return U(e, p.eq(t)).map(Q).reverse()
                },
                ...
                splitPoint: function(t, e) {
                    var n, o, i = e ? $ : A, r = U(t.node, i), a = y.last(r) || t.node;
                    i(a) ? (n = r[r.length - 2],
                ...
                isCustomStyleTag: function(t) {
                    return t && !w(t) && y.contains(t.classList, "note-styletag")
                }
            };
            function tu(t, e) {
            ...
            var td = function() {
                ...
                n = [{
                    ...
                    value: function() {
                        var t = this;
                        this.options.id = p.uniqueId(e().now()),
                    ...
                    value: function(t) {
                        ...
                        e.shouldInitialize = e.shouldInitialize || p.ok,
                        e.shouldInitialize() && (e.initialize && e.initialize(),
                        e.events && tc.attachEvents(this.$note, e.events))
                    }
                }, {
                    key: "module",
                    ...
                    value: function(t) {
                        var e = this.modules[t];
                        e.shouldInitialize() && (e.events && tc.detachEvents(this.$note, e.events),
                        e.destroy && e.destroy()),
            ...
            function tf(t, e) {
                var n, o, i = t.parentElement(), r = document.body.createTextRange(), a = y.from(i.childNodes);
                ...
                if (0 !== n && tc.isText(a[n - 1])) {
                    ...
                    for (var u = c.text.replace(/[\r\n]/g, "").length; u > l.nodeValue.length && l.nextSibling; )
                        ...
                        l = l.nextSibling;
                    l.nodeValue,
                    e && l.nextSibling && tc.isText(l.nextSibling) && u === l.nodeValue.length && (u -= l.nodeValue.length,
                    l = l.nextSibling),
                    i = l,
                    n = u
                }
            ...
            function tp(t) {
                var e = document.body.createTextRange()
                  , n = function t(e, n) {
                    var o, i;
                    if (tc.isText(e)) {
                        var r = tc.listPrev(e, p.not(tc.isText))
                          , a = y.last(r).previousSibling;
                        o = a || e.parentNode,
                        n += y.sum(y.tail(r), tc.nodeLength),
                        i = !a
                    } else {
            ...
            e().fn.extend({
                summernote: function() {
                    var t = e().type(y.head(arguments))
                      , n = e().extend({}, e().summernote.options, "object" === t ? y.head(arguments) : {});
                    n.langInfo = e().extend(!0, {}, e().summernote.lang["en-US"], e().summernote.lang[n.lang]),
                    n.icons = e().extend(!0, {}, e().summernote.options.icons, n.icons),
                    n.tooltip = "auto" === n.tooltip ? !h.isSupportTouch : n.tooltip,
                    this.each(function(t, o) {
                        var i = e()(o);
                        if (!i.data("summernote")) {
                            var r = new td(i,n);
                            i.data("summernote", r),
                            i.data("summernote").triggerEvent("init", r.layoutInfo)
                        }
                    });
                    var o = this.first();
                    if (o.length) {
                        var i = o.data("summernote");
                        if ("string" === t)
                            return i.invoke.apply(i, y.from(arguments));
                        n.focus && i.invoke("editor.focus")
                    }
                    return this
                }
            });
            var tv = function() {
                ...
                function i(t, e, n, o) {
                    ...
                    this.ec = n,
                    this.eo = o,
                    this.isOnEditable = this.makeIsOn(tc.isEditable),
                    this.isOnList = this.makeIsOn(tc.isList),
                    this.isOnAnchor = this.makeIsOn(tc.isAnchor),
                    this.isOnCell = this.makeIsOn(tc.isCell),
                    this.isOnData = this.makeIsOn(tc.isData)
                }
                return t = i,
                n = [{
                    key: "nativeRange",
                    value: function() {
                        ...
                        return e.setEndPoint("EndToEnd", tp({
                            node: this.ec,
                            offset: this.eo
                        })),
                        e
                    ...
                    value: function() {
                        var t = function(t, e) {
                            if (!t || tc.isVisiblePoint(t) && (!tc.isEdgePoint(t) || tc.isRightEdgePoint(t) && !e || tc.isLeftEdgePoint(t) && e || tc.isRightEdgePoint(t) && e && tc.isVoid(t.node.nextSibling) || tc.isLeftEdgePoint(t) && !e && tc.isVoid(t.node.previousSibling) || tc.isBlock(t.node) && tc.isEmpty(t.node)))
                                return t;
                            var n = tc.ancestor(t.node, tc.isBlock)
                              , o = !1;
                            if (!o) {
                                var i = tc.prevPoint(t) || {
                                    node: null
                                };
                                o = (tc.isLeftEdgePointOf(t, n) || tc.isVoid(i.node)) && !e
                            }
                            var r = !1;
                            if (!r) {
                                var a = tc.nextPoint(t) || {
                                    node: null
                                };
                                r = (tc.isRightEdgePointOf(t, n) || tc.isVoid(a.node)) && e
                            }
                            if (o || r) {
                                if (tc.isVisiblePoint(t))
                                    return t;
                                e = !e
                            }
                            return (e ? tc.nextPointUntil(tc.nextPoint(t), tc.isVisiblePoint) : tc.prevPointUntil(tc.prevPoint(t), tc.isVisiblePoint)) || t
                        }
                          , e = t(this.getEndPoint(), !1)
                          , n = this.isCollapsed() ? e : t(this.getStartPoint(), !0);
                        return new i(n.node,n.offset,e.node,e.offset)
                    }
                }, {
                    key: "nodes",
                    value: function(t, e) {
                        ...
                        var n = e && e.includeAncestor
                          ...
                          , a = []
                          , s = [];
                        return tc.walkPoint(i, r, function(e) {
                            var i;
                            tc.isEditable(e.node) || (o ? (tc.isLeftEdgePoint(e) && s.push(e.node),
                            tc.isRightEdgePoint(e) && y.contains(s, e.node) && (i = e.node)) : i = n ? tc.ancestor(e.node, t) : e.node,
                            i && t(i) && a.push(i))
                        }, !0),
                        y.unique(a)
                    }
                    ...
                    key: "commonAncestor",
                    value: function() {
                        return tc.commonAncestor(this.sc, this.ec)
                    }
                }, {
                    key: "expand",
                    value: function(t) {
                        var e = tc.ancestor(this.sc, t)
                          , n = tc.ancestor(this.ec, t);
                        if (!e && !n)
                            return new i(this.sc,this.so,this.ec,this.eo);
                        var o = this.getPoints();
                        return e && (o.sc = e,
                        o.so = 0),
                        n && (o.ec = n,
                        o.eo = tc.nodeLength(n)),
                        new i(o.sc,o.so,o.ec,o.eo)
                    }
                }, {
                    key: "collapse",
                    value: function(t) {
                        return t ? new i(this.sc,this.so,this.sc,this.so) : new i(this.ec,this.eo,this.ec,this.eo)
                    }
                }, {
                    key: "splitText",
                    value: function() {
                        var t = this.sc === this.ec
                          , e = this.getPoints();
                        return tc.isText(this.ec) && !tc.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
                        tc.isText(this.sc) && !tc.isEdgePoint(this.getStartPoint()) && (e.sc = this.sc.splitText(this.so),
                        e.so = 0,
                        t && (e.ec = e.sc,
                        e.eo = this.eo - this.so)),
                        new i(e.sc,e.so,e.ec,e.eo)
                    }
                }, {
                    key: "deleteContents",
                    value: function() {
                        ...
                        var t = this.splitText()
                          ...
                          , o = tc.prevPointUntil(t.getStartPoint(), function(t) {
                            return !y.contains(n, t.node)
                        })
                          , r = [];
                        return e().each(n, function(t, e) {
                            var n = e.parentNode;
                            o.node !== n && 1 === tc.nodeLength(n) && r.push(n),
                            tc.remove(e, !1)
                        }),
                        e().each(r, function(t, e) {
                            tc.remove(e, !1)
                        }),
                        new i(o.node,o.offset,o.node,o.offset).normalize()
                    }
                }, {
                    key: "makeIsOn",
                    value: function(t) {
                        return function() {
                            var e = tc.ancestor(this.sc, t);
                            return !!e && e === tc.ancestor(this.ec, t)
                        }
                    }
                }, {
                    key: "isLeftEdgeOf",
                    value: function(t) {
                        if (!tc.isLeftEdgePoint(this.getStartPoint()))
                            return !1;
                        var e = tc.ancestor(this.sc, t);
                        return e && tc.isLeftEdgeOf(this.sc, e)
                    }
                }, {
                    key: "isCollapsed",
                    value: function() {
                    ...
                    value: function() {
                        if (tc.isBodyContainer(this.sc) && tc.isEmpty(this.sc))
                            return this.sc.innerHTML = tc.emptyPara,
                            new i(this.sc.firstChild,0,this.sc.firstChild,0);
                        var t, e = this.normalize();
                        if (tc.isParaInline(this.sc) || tc.isPara(this.sc))
                            return e;
                        if (tc.isInline(e.sc)) {
                            var n = tc.listAncestor(e.sc, p.not(tc.isInline));
                            t = y.last(n),
                            tc.isInline(t) || (t = n[n.length - 2] || e.sc.childNodes[e.so])
                        } else
                            t = e.sc.childNodes[e.so > 0 ? e.so - 1 : 0];
                        if (t) {
                            var o = tc.listPrev(t, tc.isParaInline).reverse();
                            if ((o = o.concat(tc.listNext(t.nextSibling, tc.isParaInline))).length) {
                                var r = tc.wrap(y.head(o), "p");
                                tc.appendChildNodes(r, y.tail(o))
                            }
                        }
                    ...
                    value: function(t) {
                        var e = this;
                        (tc.isText(t) || tc.isInline(t)) && (e = this.wrapBodyInlineWithPara().deleteContents());
                        var n = tc.splitPoint(e.getStartPoint(), tc.isInline(t));
                        return n.rightNode ? (n.rightNode.parentNode.insertBefore(t, n.rightNode),
                        tc.isEmpty(n.rightNode) && tc.isPara(t) && n.rightNode.parentNode.removeChild(n.rightNode)) : n.container.appendChild(t),
                        t
                    }
                }, {
                    key: "pasteHTML",
                    ...
                    value: function(t) {
                        ...
                        if (!tc.isCharPoint(e))
                            return this;
                        var n = tc.prevPointUntil(e, function(t) {
                            return !tc.isCharPoint(t)
                        });
                        return t && (e = tc.nextPointUntil(e, function(t) {
                            return !tc.isCharPoint(t)
                        })),
                        new i(n.node,n.offset,e.node,e.offset)
                    }
                }, {
                    key: "getWordsRange",
                    value: function(t) {
                        var e = this.getEndPoint()
                          , n = function(t) {
                            return !tc.isCharPoint(t) && !tc.isSpacePoint(t)
                        };
                        if (n(e))
                            return this;
                        var o = tc.prevPointUntil(e, n);
                        return t && (e = tc.nextPointUntil(e, n)),
                        new i(o.node,o.offset,e.node,e.offset)
                    }
                }, {
                    key: "getWordsMatchRange",
                    value: function(t) {
                        var e = this.getEndPoint()
                          , n = tc.prevPointUntil(e, function(n) {
                            if (!tc.isCharPoint(n) && !tc.isSpacePoint(n))
                                return !0;
                            var o = new i(n.node,n.offset,e.node,e.offset)
                              , r = t.exec(o.toString());
                            return r && 0 === r.index
                        })
                          , o = new i(n.node,n.offset,e.node,e.offset)
                          , r = o.toString()
                          , a = t.exec(r);
                        return a && a[0].length === r.length ? o : null
                    }
                }, {
                    key: "bookmark",
                    value: function(t) {
                        return {
                            s: {
                                path: tc.makeOffsetPath(t, this.sc),
                                offset: this.so
                            },
                            e: {
                                path: tc.makeOffsetPath(t, this.ec),
                                offset: this.eo
                            }
                        }
                    }
                    ...
                    value: function(t) {
                        return {
                            s: {
                                path: y.tail(tc.makeOffsetPath(y.head(t), this.sc)),
                                offset: this.so
                            },
                            e: {
                                path: y.tail(tc.makeOffsetPath(y.last(t), this.ec)),
                                offset: this.eo
                            }
                        }
                    }
            ...
            let tm = {
                create: function(t, e, n, o) {
                    ...
                    if (2 === arguments.length)
                        return new tv(t,e,n = t,o = e);
                    var i = this.createFromSelection();
                    if (!i && 1 === arguments.length) {
                        var r = arguments[0];
                        return tc.isEditable(r) && (r = r.lastChild),
                        this.createFromBodyElement(r, tc.emptyPara === arguments[0].innerHTML)
                    }
                    return i
                },
                ...
                createFromSelection: function() {
                    ...
                    if (h.isW3CRangeSupport) {
                        ...
                        if (!i || 0 === i.rangeCount || tc.isBody(i.anchorNode))
                            return null;
                        ...
                        var c = tf(l, !0)
                          , u = tf(s, !1);
                        tc.isText(c.node) && tc.isLeftEdgePoint(c) && tc.isTextNode(u.node) && tc.isRightEdgePoint(u) && u.node.nextSibling === c.node && (c = u),
                        t = c.cont,
                        e = c.offset,
                        n = u.cont,
                        o = u.offset
                ...
                createFromNode: function(t) {
                    var e = t
                      ...
                      , o = t
                      , i = tc.nodeLength(o);
                    return tc.isVoid(e) && (n = tc.listPrev(e).length - 1,
                    e = e.parentNode),
                    tc.isBR(o) ? (i = tc.listPrev(o).length - 1,
                    o = o.parentNode) : tc.isVoid(o) && (i = tc.listPrev(o).length,
                    o = o.parentNode),
                    this.create(e, n, o, i)
                },
                ...
                createFromBookmark: function(t, e) {
                    var n = tc.fromOffsetPath(t, e.s.path)
                      , o = e.s.offset
                      , i = tc.fromOffsetPath(t, e.e.path)
                      , r = e.e.offset;
                    return new tv(n,o,i,r)
                },
                createFromParaBookmark: function(t, e) {
                    var n = t.s.offset
                      , o = t.e.offset
                      , i = tc.fromOffsetPath(y.head(e), t.s.path)
                      , r = tc.fromOffsetPath(y.last(e), t.e.path);
                    return new tv(i,n,r,o)
                }
            };
            var tg = {
                BACKSPACE: 8,
            ...
            let tb = {
                isEdit: function(t) {
                    return y.contains([tg.BACKSPACE, tg.TAB, tg.ENTER, tg.SPACE, tg.DELETE], t)
                },
                isMove: function(t) {
                    return y.contains([tg.LEFT, tg.UP, tg.RIGHT, tg.DOWN], t)
                },
                isNavigation: function(t) {
                    return y.contains([tg.HOME, tg.END, tg.PAGEUP, tg.PAGEDOWN], t)
                },
                nameFromCode: p.invertObject(tg),
                code: tg
            };
            function ty(t, e) {
                for (var n = 0; n < e.length; n++) {
            ...
            var tk = function() {
                ...
                e = [{
                    ...
                    value: function(t) {
                        ...
                        null !== t.bookmark && tm.createFromBookmark(this.editable, t.bookmark).select()
                    }
                }, {
                    key: "rewind",
                    value: function() {
            ...
            var tw = function() {
                ...
                n = [{
                    ...
                    value: function(t, n) {
                        ...
                        if (t.isCollapsed())
                            return [t.insertNode(tc.create(o))];
                        var a = tc.makePredByNodeName(o)
                          , s = t.nodes(tc.isText, {
                            fullyContains: !0
                        }).map(function(t) {
                            return tc.singleChildAncestor(t, a) || tc.wrap(t, o)
                        });
                        if (i) {
                            if (r) {
                                var l = t.nodes();
                                a = p.and(a, function(t) {
                                    return y.contains(l, t)
                                })
                            }
                            return s.map(function(t) {
                                var n = tc.withClosestSiblings(t, a)
                                  , o = y.head(n)
                                  , i = y.tail(n);
                                return e().each(i, function(t, e) {
                                    tc.appendChildNodes(o, e.childNodes),
                                    tc.remove(e)
                                }),
                                y.head(n)
                            })
                    ...
                    key: "current",
                    value: function(t) {
                        var n = e()(tc.isElement(t.sc) ? t.sc : t.sc.parentNode)
                          , o = this.fromNode(n);
                        try {
                            o = e().extend(o, {
                        ...
                        if (t.isOnList()) {
                            var r = ["circle", "disc", "disc-leading-zero", "square"].indexOf(o["list-style-type"]) > -1;
                            o["list-style"] = r ? "unordered" : "ordered"
                        } else
                            o["list-style"] = "none";
                        var a = tc.ancestor(t.sc, tc.isPara);
                        ...
                        return o.anchor = t.isOnAnchor() && tc.ancestor(t.sc, tc.isAnchor),
                        o.ancestors = tc.listAncestor(t.sc, tc.isEditable),
                        o.range = t,
                        o
                    }
                }, ],
            ...
            var t$ = function() {
                ...
                n = [{
                    ...
                    value: function(t) {
                        var n = this
                          , o = tm.create(t).wrapBodyInlineWithPara()
                          , i = o.nodes(tc.isPara, {
                            includeAncestor: !0
                        })
                          , r = y.clusterBy(i, p.peq2("parentNode"));
                    ...
                    value: function(t) {
                        ...
                        e().each(r, function(t, o) {
                            var i = y.head(o);
                            tc.isLi(i) ? n.releaseList([o]) : e().each(o, function(t, n) {
                                e()(n).css("marginLeft", function(t, e) {
                    ...
                    value: function(t, n) {
                        var o = this
                          , i = tm.create(n).wrapBodyInlineWithPara()
                          , r = i.nodes(tc.isPara, {
                            includeAncestor: !0
                        })
                          , a = i.paraBookmark(r)
                          , s = y.clusterBy(r, p.peq2("parentNode"));
                        if (y.find(r, tc.isPurePara)) {
                            var l = [];
                        ...
                        tm.createFromParaBookmark(a, r).select()
                    }
                }, {
                    key: "wrapList",
                    value: function(t, e) {
                        var n = y.head(t)
                          , o = y.last(t)
                          , i = tc.isList(n.previousSibling) && n.previousSibling
                          , r = tc.isList(o.nextSibling) && o.nextSibling
                          , a = i || tc.insertAfter(tc.create(e || "UL"), o);
                        return t = t.map(function(t) {
                            return tc.isPurePara(t) ? tc.replace(t, "LI") : t
                        }),
                        tc.appendChildNodes(a, t),
                        r && (tc.appendChildNodes(a, y.from(r.childNodes)),
                        tc.remove(r)),
                        t
                    }
                }, {
                    ...
                    value: function(t, n) {
                        ...
                        return e().each(t, function(t, r) {
                            var a = y.head(r)
                              , s = y.last(r)
                              , l = n ? tc.lastAncestor(a, tc.isList) : a.parentNode
                              , c = l.parentNode;
                            if ("LI" === l.parentNode.nodeName)
                                ...
                                var u = l.childNodes.length > 1 ? tc.splitTree(l, {
                                    node: s.parentNode,
                                    offset: tc.position(s) + 1
                                }, {
                                    isSkipPaddingBlankHTML: !0
                                }) : null
                                  , d = tc.splitTree(l, {
                                    node: a.parentNode,
                                    offset: tc.position(a)
                                }, {
                                    isSkipPaddingBlankHTML: !0
                                });
                                r = n ? tc.listDescendant(d, tc.isLi) : y.from(d.childNodes).filter(tc.isLi),
                                !n && tc.isList(l.parentNode) || (r = r.map(function(t) {
                                    return tc.replace(t, "P")
                                })),
                                ...
                                e().each(h, function(t, n) {
                                    var o = [n].concat(tc.listDescendant(n, tc.isList));
                                    e().each(o.reverse(), function(t, e) {
                                        tc.nodeLength(e) || tc.remove(e, !0)
                                    })
                                })
                            }
                            i = i.concat(r)
                    ...
                    value: function(t) {
                        return t.previousSibling ? tc.appendChildNodes(t.previousSibling, [t]) : this.wrapList([t], "LI")
                    }
                }, {
                    key: "findList",
                    value: function(t) {
            ...
            var t9 = function() {
                ...
                n = [{
                    key: "insertTab",
                    value: function(t, e) {
                        var n = tc.createText(Array(e + 1).join(tc.NBSP_CHAR));
                        (t = t.deleteContents()).insertNode(n, !0),
                        (t = tm.create(n, e)).select()
                    }
                }, {
                    key: "insertParagraph",
                    value: function(t, n) {
                        n = (n = (n = n || tm.create(t)).deleteContents()).wrapBodyInlineWithPara();
                        var o, i = tc.ancestor(n.sc, tc.isPara);
                        if (i) {
                            if (tc.isLi(i) && (tc.isEmpty(i) || tc.deepestChildIsEmpty(i)))
                                return void this.bullet.toggleList(i.parentNode.nodeName);
                            var r = null;
                            if (1 === this.options.blockquoteBreakingLevel ? r = tc.ancestor(i, tc.isBlockquote) : 2 === this.options.blockquoteBreakingLevel && (r = tc.lastAncestor(i, tc.isBlockquote)),
                            r) {
                                o = e()(tc.emptyPara)[0],
                                tc.isRightEdgePoint(n.getStartPoint()) && tc.isBR(n.sc.nextSibling) && e()(n.sc.nextSibling).remove();
                                var a = tc.splitTree(r, n.getStartPoint(), {
                                    isDiscardEmptySplits: !0
                                });
                                a ? a.parentNode.insertBefore(o, a) : tc.insertAfter(o, r)
                            } else {
                                o = tc.splitTree(i, n.getStartPoint());
                                var s = tc.listDescendant(i, tc.isEmptyAnchor);
                                s = s.concat(tc.listDescendant(o, tc.isEmptyAnchor)),
                                e().each(s, function(t, e) {
                                    tc.remove(e)
                                }),
                                (tc.isHeading(o) || tc.isPre(o) || tc.isCustomStyleTag(o)) && tc.isEmpty(o) && (o = tc.replace(o, "p"))
                            }
                        } else {
                        ...
                        tm.create(o, 0).normalize().select().scrollIntoView(t)
                    }
                }, ],
                tS(t.prototype, n),
                o && tS(t, o),
            ...
            var tN = function() {
                ...
                n = [{
                    key: "tab",
                    value: function(t, e) {
                        var n = tc.ancestor(t.commonAncestor(), tc.isCell)
                          , o = tc.ancestor(n, tc.isTable)
                          , i = tc.listDescendant(o, tc.isCell)
                          , r = y[e ? "prev" : "next"](i, n);
                        r && tm.create(r, 0).select()
                    }
                }, {
                    key: "addRow",
                    value: function(t, n) {
                        for (var o = tc.ancestor(t.commonAncestor(), tc.isCell), i = e()(o).closest("tr"), r = this.recoverAttributes(i), a = e()("<tr" + r + "></tr>"), s = new tE(o,tE.where.Row,tE.requestAction.Add,e()(i).closest("table")[0]).getActionList(), l = 0; l < s.length; l++) {
                            var c = s[l]
                              , u = this.recoverAttributes(c.baseCell);
                            switch (c.action) {
                            case tE.resultAction.AddCell:
                                a.append("<td" + u + ">" + tc.blank + "</td>");
                                break;
                            case tE.resultAction.SumSpanCount:
                                if ("top" === n && (c.baseCell.parent ? c.baseCell.closest("tr").rowIndex : 0) <= i[0].rowIndex) {
                                    var d = e()("<div></div>").append(e()("<td" + u + ">" + tc.blank + "</td>").removeAttr("rowspan")).html();
                                    a.append(d);
                                    break
                                }
                    ...
                    key: "addCol",
                    value: function(t, n) {
                        var o = tc.ancestor(t.commonAncestor(), tc.isCell)
                          , i = e()(o).closest("tr");
                        e()(i).siblings().push(i);
                        for (var r = new tE(o,tE.where.Column,tE.requestAction.Add,e()(i).closest("table")[0]).getActionList(), a = 0; a < r.length; a++) {
                            var s = r[a]
                              , l = this.recoverAttributes(s.baseCell);
                            switch (s.action) {
                            case tE.resultAction.AddCell:
                                "right" === n ? e()(s.baseCell).after("<td" + l + ">" + tc.blank + "</td>") : e()(s.baseCell).before("<td" + l + ">" + tc.blank + "</td>");
                                break;
                            case tE.resultAction.SumSpanCount:
                                if ("right" === n) {
                                    ...
                                    e()(s.baseCell).before("<td" + l + ">" + tc.blank + "</td>")
                            }
                        }
                    }
                }, {
                    ...
                    key: "deleteRow",
                    value: function(t) {
                        for (var n = tc.ancestor(t.commonAncestor(), tc.isCell), o = e()(n).closest("tr"), i = o.children("td, th").index(e()(n)), r = o[0].rowIndex, a = new tE(n,tE.where.Row,tE.requestAction.Delete,e()(o).closest("table")[0]).getActionList(), s = 0; s < a.length; s++)
                            if (a[s]) {
                                var l = a[s].baseCell
                                  , c = a[s].virtualTable
                    ...
                    key: "deleteCol",
                    value: function(t) {
                        for (var n = tc.ancestor(t.commonAncestor(), tc.isCell), o = e()(n).closest("tr"), i = o.children("td, th").index(e()(n)), r = new tE(n,tE.where.Column,tE.requestAction.Delete,e()(o).closest("table")[0]).getActionList(), a = 0; a < r.length; a++)
                            if (r[a])
                                switch (r[a].action) {
                                case tE.resultAction.Ignore:
                                    continue;
            ...
            var tP = function() {
                ...
                function i(t) {
                    ...
                    this.style = new tw,
                    this.table = new tN,
                    this.typing = new t9(t),
                    this.bullet = new t$,
                    this.history = new tk(t),
                    ...
                    this.fontName = this.wrapCommand(function(t) {
                        return n.fontStyling("font-family", h.validFontName(t))
                    }),
                    ...
                    this.insertNode = this.wrapCommand(function(t) {
                        n.isLimited(e()(t).text().length) || (n.getLastRange().insertNode(t),
                        n.setLastRange(tm.createFromNodeAfter(t).select()))
                    }),
                    this.insertText = this.wrapCommand(function(t) {
                        if (!n.isLimited(t.length)) {
                            var e = n.getLastRange().insertNode(tc.createText(t));
                            n.setLastRange(tm.create(e, tc.nodeLength(e)).select())
                        }
                    }),
                    this.pasteHTML = this.wrapCommand(function(t) {
                        if (!n.isLimited(t.length)) {
                            ...
                            n.setLastRange(tm.createFromNodeAfter(y.last(e)).select())
                        }
                    }),
                    ...
                    this.insertHorizontalRule = this.wrapCommand(function() {
                        var t = n.getLastRange().insertNode(tc.create("HR"));
                        t.nextSibling && n.setLastRange(tm.create(t.nextSibling, 0).normalize().select())
                    }),
                    ...
                    this.removeMedia = this.wrapCommand(function() {
                        ...
                        t.closest("figure").length ? t.closest("figure").remove() : t = e()(n.restoreTarget()).detach(),
                ...
                n = [{
                    ...
                    value: function() {
                        ...
                        this.$editable.on("keydown", function(e) {
                            if (e.keyCode === tb.code.ENTER && t.context.triggerEvent("enter", e),
                        ...
                        this.$editable.html(tc.html(this.$note) || tc.emptyPara),
                        this.$editable.on(h.inputEventName, p.debounce(function() {
                    ...
                    value: function(t) {
                        ...
                        var o = tb.nameFromCode[t.keyCode];
                        o && n.push(o);
                        var i = e[n.join("+")];
                        if ("TAB" !== o || this.options.tabDisable) {
                            if (i) {
                                ...
                                tb.isEdit(t.keyCode) && this.afterCommand()
                        } else
                            this.afterCommand();
                        return !1
                    }
                    ...
                    value: function(t, e) {
                        return t = t || 0,
                        (void 0 === e || !(tb.isMove(e.keyCode) || tb.isNavigation(e.keyCode) || e.ctrlKey || e.metaKey || y.contains([tb.code.BACKSPACE, tb.code.DELETE], e.keyCode))) && this.options.maxTextLength > 0 && this.$editable.text().length + t > this.options.maxTextLength
                    }
                }, {
                    key: "createRange",
                    value: function() {
                    ...
                    value: function(t) {
                        var e = tm.createFromNodeBefore(y.head(t)).getStartPoint()
                          , n = tm.createFromNodeAfter(y.last(t)).getEndPoint();
                        return tm.create(e.node, e.offset, n.node, n.offset)
                    }
                }, {
                    key: "setLastRange",
                    value: function(t) {
                        t ? this.lastRange = t : (this.lastRange = tm.create(this.editable),
                        0 === e()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = tm.createFromBodyElement(this.editable)))
                    }
                }, {
                    key: "getLastRange",
                    value: function() {
                    ...
                    value: function(t, n) {
                        ...
                        e().Deferred(function(t) {
                            ...
                            i.setLastRange(tm.createFromNodeAfter(t[0]).select()),
                            i.afterCommand()
                        }).fail(function(t) {
                    ...
                    value: function(t) {
                        ...
                        e().each(t, function(t, o) {
                            var i, r = o.name;
                            n.options.maximumImageFileSize && n.options.maximumImageFileSize < o.size ? n.context.triggerEvent("image.upload.error", n.lang.image.maximumFileSizeError) : (i = o,
                            e().Deferred(function(t) {
                    ...
                    value: function() {
                        var t = this.getLastRange();
                        return t.isOnAnchor() && (t = tm.createFromNode(tc.ancestor(t.sc, tc.isAnchor))),
                        t.toString()
                    }
                }, {
                    key: "onFormatBlock",
                    value: function(t, n) {
                        if (document.execCommand("FormatBlock", !1, h.isMSIE ? "<" + t + ">" : t),
                    ...
                    value: function(t, n) {
                        ...
                        if ("" !== o) {
                            ...
                            o.isCollapsed()) {
                                var r = y.head(i);
                                r && !tc.nodeLength(r) && (r.innerHTML = tc.ZERO_WIDTH_NBSP_CHAR,
                                tm.createFromNode(r.firstChild).select(),
                                this.setLastRange(),
                    ...
                    value: function() {
                        var t = this.getLastRange();
                        if (t.isOnAnchor()) {
                            var e = tc.ancestor(t.sc, tc.isAnchor);
                            (t = tm.createFromNode(e)).select(),
                            this.setLastRange(),
                            this.beforeCommand(),
                    ...
                    key: "getLinkInfo",
                    value: function() {
                        var t = this.getLastRange().expand(tc.isAnchor)
                          , n = e()(y.head(t.nodes(tc.isAnchor)))
                          , o = {
                            range: t,
                            text: t.toString(),
                    ...
                    key: "isEmpty",
                    value: function() {
                        return tc.isEmpty(this.$editable[0]) || tc.emptyPara === this.$editable.html()
                    }
                }, {
                    key: "empty",
                    value: function() {
                        this.context.invoke("code", tc.emptyPara)
                    }
                }, {
                ...
                e = [{
                    ...
                    value: function(t) {
                        ...
                        if (n && n.items && n.items.length) {
                            var o = n.items.length > 1 ? n.items[1] : y.head(n.items);
            ...
            var tA = function() {
                ...
                function i(t) {
                    ...
                    this.$dropzone = e()('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>').prependTo(this.$editor)
                }
                return t = i,
                n = [{
                    key: "initialize",
                ...
                e = [{
                    ...
                    value: function() {
                        ...
                        this.$codable.on("keyup", function(e) {
                            e.keyCode === tb.code.ESCAPE && t.deactivate()
                        })
                    }
                }, {
                    key: "isActivated",
                        ...
                        this.options.codeviewIframeFilter)) {
                            ...
                            t = t.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function(t) {
                                ...
                                var n, o = function t(e, n) {
                                    ...
                                    if (!o) {
                                        if (Array.isArray(e) || (o = function(t, e) {
                                            if (t) {
                                                if ("string" == typeof t)
                                                    return tF(t, e);
                                ...
                                try {
                                    for (o.s(); !(n = o.n()).done; ) {
                                        var i = n.value;
                                        if (RegExp('src="(https?:)?//' + i.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") + '/(.+)"').test(t))
                                            return t
                                    }
                                } catch (r) {
                                    o.e(r)
                    ...
                    value: function() {
                        ...
                        if (this.$codable.val(tc.html(this.$editable, this.options.prettifyHtml)),
                    ...
                    value: function() {
                        ...
                        var e = this.purify(tc.value(this.$codable, this.options.prettifyHtml) || tc.emptyPara)
                ...
                n = [{
                    ...
                    value: function() {
                        ...
                        this.$handle.on("mousedown", function(e) {
                            if (tc.isControlSizing(e.target)) {
                                e.preventDefault(),
                                e.stopPropagation();
            ...
            var t4 = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/]{2}|tel:|mailto:[A-Z0-9._%+-]+@|xmpp:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i
              , t1 = function() {
                var t, n, o;
                function i(t) {
                    var e = this;
                ...
                n = [{
                    ...
                    key: "handleKeydown",
                    value: function(t) {
                        if (y.contains([tb.code.ENTER, tb.code.SPACE], t.keyCode)) {
                    ...
                    key: "handleKeyup",
                    value: function(t) {
                        y.contains([tb.code.ENTER, tb.code.SPACE], t.keyCode) && this.replace()
                    }
                }, ],
                tW(t.prototype, n),
                o && tW(t, o),
            ...
            var tK = function() {
                ...
                e = [{
                    ...
                    value: function() {
                        return tc.isTextarea(this.$note[0])
                    }
                }, ],
                tj(t.prototype, e),
                n && tj(t, n),
            ...
            var t2 = function() {
                ...
                function o(t) {
                    ...
                    this.keys = [tb.code.ENTER, tb.code.SPACE, tb.code.PERIOD, tb.code.COMMA, tb.code.SEMICOLON, tb.code.SLASH, ],
                    ...
                    value: function() {
                        if (this.lastWord) {
                            ...
                            this.options.match(e, function(e) {
                                if (e) {
                                    var n = "";
                                    "string" == typeof e ? n = tc.createText(e) : e instanceof jQuery ? n = e[0] : e instanceof Node && (n = e),
                                    n && (t.lastWord.insertNode(n),
                                    t.lastWord = null,
            ...
            var t7 = function() {
                ...
                function i(t) {
                    ...
                    this.options = t.options,
                    this.lang = this.options.langInfo,
                    this.invertedKeyMap = p.invertObject(this.options.keyMap[h.isMac ? "mac" : "pc"])
                }
                return t = i,
                n = [{
                    ...
                    value: function(t) {
                        ...
                        return this.options.shortcuts && e ? (h.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")),
                    ...
                    key: "isFontInstalled",
                    value: function(t) {
                        return Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) || (this.fontInstalledMap[t] = h.isFontInstalled(t) || y.contains(this.options.fontNamesIgnoreCheck, t)),
                        this.fontInstalledMap[t]
                    }
                }, {
                    key: "isFontDeservedToAdd",
                    value: function(t) {
                        return "" !== (t = t.toLowerCase()) && this.isFontInstalled(t) && -1 === h.genericFontFamilies.indexOf(t)
                    }
                }, {
                    key: "colorPalette",
                                ...
                                click: function(n) {
                                    ...
                                    if ("openPalette" === a) {
                                        ...
                                        if (y.contains(["backColor", "foreColor"], a)) {
                                            var h = i.closest(".note-color").find(".note-recent-color")
                                              , f = i.closest(".note-color").find(".note-current-color-button");
                                            h.css("backColor" === a ? "background-color" : "color", s),
                                            f.attr("data-" + a, s)
                                        }
                    ...
                    value: function() {
                        ...
                        for (var n = 0, o = this.options.styleTags.length; n < o; n++)
                            (function(e, n) {
                        ...
                        this.context.memo("button.fontname", function() {
                            ...
                            t.ui.buttonGroup([t.button({
                                ...
                                template: function(t) {
                                    return '<span style="font-family: ' + h.validFontName(t) + '">' + t + "</span>"
                                },
                        ...
                        this.context.memo("button.justifyLeft", p.invoke(i, "render")),
                        this.context.memo("button.justifyCenter", p.invoke(r, "render")),
                        this.context.memo("button.justifyRight", p.invoke(a, "render")),
                        this.context.memo("button.justifyFull", p.invoke(s, "render")),
                        this.context.memo("button.outdent", p.invoke(l, "render")),
                        this.context.memo("button.indent", p.invoke(c, "render")),
                        ...
                        this.context.memo("button.table", function() {
                            return t.ui.buttonGroup([t.button({
                                ...
                                items: '<div class="note-dimension-picker"><div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"></div><div class="note-dimension-picker-highlighted"></div><div class="note-dimension-picker-unhighlighted"></div></div><div class="note-dimension-display">1 x 1</div>'
                            }), ], {
                                callback: function(e) {
                ...
                n = [{
                    ...
                    value: function() {
                        var t = this.options.dialogsInBody ? this.$body : this.options.container
                          , n = ['<div class="form-group note-form-group mb-6">', '<label for="note-dialog-link-txt-'.concat(this.options.id, '" class="note-form-label form-label">').concat(this.lang.link.textToDisplay, "</label>"), '<input id="note-dialog-link-txt-'.concat(this.options.id, '" class="note-link-text form-control note-form-control note-input" type="text"/>'), "</div>", '<div class="form-group note-form-group mb-6">', '<label for="note-dialog-link-url-'.concat(this.options.id, '" class="note-form-label form-label">').concat(this.lang.link.url, "</label>"), '<input id="note-dialog-link-url-'.concat(this.options.id, '" class="note-link-url form-control note-form-control note-input" type="text" value="http://"/>'), "</div>", this.options.disableLinkTarget ? "" : e()("<div></div>").append(this.ui.checkbox({
                            className: "sn-checkbox-open-in-new-window mb-3",
                            text: this.lang.link.openInNewWindow,
                            checked: !0
                        }).render()).html(), e()("<div></div>").append(this.ui.checkbox({
                            className: "sn-checkbox-use-protocol mb-3",
                    ...
                    value: function(t, e) {
                        t.on("keypress", function(t) {
                            t.keyCode === tb.code.ENTER && (t.preventDefault(),
                            e.trigger("click"))
                        })
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        return e().Deferred(function(e) {
                            ...
                            n.ui.onDialogShown(n.$dialog, function() {
                                ...
                                !t.url && p.isValidUrl(t.text) && (t.url = t.text),
                    ...
                    value: function() {
                        if (this.context.invoke("editor.hasFocus")) {
                            ...
                            if (t.isCollapsed() && t.isOnAnchor()) {
                                var n = tc.ancestor(t.sc, tc.isAnchor)
                                  , o = e()(n).attr("href");
                                this.$popover.find("a").attr("href", o).text(o);
                                var i = tc.posFromPlaceholder(n)
                ...
                n = [{
                    ...
                    value: function() {
                        ...
                        var o = this.options.dialogsInBody ? this.$body : this.options.container
                          , i = ['<div class="form-group note-form-group note-group-select-from-files">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-form-label form-label">' + this.lang.image.selectFromFiles + "</label>", '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input form-control-file note-form-control note-input form-control mb-6" ', ' type="file" name="files" accept="' + this.options.acceptImageFileTypes + '" multiple="multiple"/>', t, "</div>", '<div class="form-group note-group-image-url">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label form-label">' + this.lang.image.url + "</label>", '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url form-control note-form-control note-input" type="text"/>', "</div>", ].join("")
                    ...
                    value: function() {
                        ...
                        return e().Deferred(function(e) {
                            ...
                            t.ui.onDialogShown(t.$dialog, function() {
                                ...
                                h.isSupportTouch || o.trigger("focus"),
                                i.click(function(t) {
                                    t.preventDefault(),
                                    e.resolve(o.val())
                                }),
            ...
            var eo = function() {
                ...
                n = [{
                    ...
                    value: function(t) {
                        if (this.context.isDisabled())
                            return !1;
                        var n = tc.isCell(t) || tc.isCell(null == t ? void 0 : t.parentElement);
                        if (n) {
                            var o = tc.posFromPlaceholder(t)
                              , i = e()(this.options.container).offset();
                            o.top -= i.top,
                            o.left -= i.left,
                            this.$popover.css({
                    ...
                    value: function(t) {
                        ...
                        if (o && 11 === o[1].length) {
                            ...
                            if (void 0 !== o[2]) {
                                ...
                                if (y)
                                    for (var k = [3600, 60, 1], C = 0, w = k.length; C < w; C++)
                                        b += void 0 !== y[C + 1] ? k[C] * parseInt(y[C + 1], 10) : 0
                            }
                            ...
                            var E = 0;
                            "undefined" !== u[6] && (E = u[6]),
                            n = e()('<iframe allowfullscreen sandbox="allow-same-origin allow-scripts allow-popups">').attr("frameborder", 0).attr("src", "//" + u[1] + "/videos/embed/" + u[2] + "?loop=" + S + "&autoplay=" + T + "&muted=" + E + (x > 0 ? "&start=" + x : "") + ($ > 0 ? "&end=" + b : "")).attr("width", "560").attr("height", "315")
                        } else if (d && d[1].length || h && h[2].length) {
                            var N = d && d[1].length ? d[1] : h[2];
                            n = e()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "310").attr("width", "500").attr("src", "https://v.qq.com/txp/iframe/player.html?vid=" + N + "&amp;auto=0")
                        } else if (f || p || v)
            ...
            var es = function() {
                ...
                n = [{
                    ...
                    value: function() {
                        var t = this
                          , n = this.options.keyMap[h.isMac ? "mac" : "pc"];
            ...
            var ed = function() {
                ...
                n = [{
                    ...
                    value: function() {
                        ...
                        if (t.length) {
                            ...
                            "next" === this.options.hintSelect) {
                                ...
                                e()(n).after(i),
                                tm.createFromNodeBefore(i).select()
                            } else
                                tm.createFromNodeAfter(n).select();
                            this.lastWordRange = null,
                            this.hide(),
                            this.context.invoke("editor.focus"),
                            this.context.triggerEvent("change", this.$editable.html(), this.$editable)
                    ...
                    value: function(t) {
                        ...
                        return "string" == typeof o && (o = tc.createText(o)),
                        o
                    }
                }, {
                    ...
                    key: "handleKeydown",
                    value: function(t) {
                        this.$popover.is(":visible") && (t.keyCode === tb.code.ENTER ? (t.preventDefault(),
                        this.replace()) : t.keyCode === tb.code.UP ? (t.preventDefault(),
                        this.moveUp()) : t.keyCode === tb.code.DOWN && (t.preventDefault(),
                        this.moveDown()))
                    }
                }, {
                    key: "searchKeyword",
                    ...
                    value: function(t) {
                        var n = this;
                        if (!y.contains([tb.code.ENTER, tb.code.UP, tb.code.DOWN], t.keyCode)) {
                            var o, i, r = this.context.invoke("editor.getLastRange");
                            if ("words" === this.options.hintMode) {
                                if (i = (o = r.getWordsRange(r)).toString(),
                                ...
                                i = (o = r.getWordRange()).toString();
                            if (this.hints.length && i) {
                                this.$content.empty();
                                var a = p.rect2bnd(y.last(o.getClientRects()))
            ...
            let ev = function(t, e) {
                return function() {
                    var n = "object" === eh(arguments[1]) ? arguments[1] : arguments[0]
            ...
            var eg = ev('<div class="note-editor note-frame panel panel-default"></div>')
              , eb = ev('<div class="panel-heading note-toolbar" role="toolbar"></div>')
              , ey = ev('<div class="note-editing-area"></div>')
              , ek = ev('<textarea class="note-codable" aria-multiline="true"></textarea>')
              , eC = ev('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>')
              , ew = ev('<output class="note-status-output" role="status" aria-live="polite"></output><div class="note-statusbar" role="status"><div class="note-resizebar" aria-label="Resize"><div class="note-icon-bar"></div><div class="note-icon-bar"></div><div class="note-icon-bar"></div></div></div>')
              , ex = ev('<div class="note-editor note-airframe"></div>')
              , e$ = ev('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div><output class="note-status-output" role="status" aria-live="polite"></output>')
              , eS = ev('<div class="note-btn-group btn-group"></div>')
              , e9 = ev('<ul class="note-dropdown-menu dropdown-menu"></ul>', function(t, e) {
                var n = Array.isArray(e.items) ? e.items.map(function(t) {
                    var n = "string" == typeof t ? t : t.value || ""
                      , o = e.template ? e.template(t) : t
                      , i = "object" === em(t) ? t.option : void 0;
              ...
              , eT = function(t, e) {
                return t + " " + e_(e.icons.caret, "span")
            }
              , eE = ev('<ul class="note-dropdown-menu dropdown-menu note-check"></ul>', function(t, e) {
                var n = Array.isArray(e.items) ? e.items.map(function(t) {
                    var n = "string" == typeof t ? t : t.value || ""
                      , o = e.template ? e.template(t) : t;
                    return '<li aria-label="' + t + '"><a href="#" data-value="' + n + '">' + e_(e.checkClassName) + " " + o + "</a></li>"
                }).join("") : e.items;
                t.html(n).attr({
                    "aria-label": e.title
                }),
              ...
              , eN = ev('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', function(t, e) {
                e.fade && t.addClass("fade"),
                t.attr({
                    "aria-label": e.title
                }),
                t.html(['<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen-lg-down">', '<div class="modal-content">', e.title ? '<div class="modal-header"> <h4 class="modal-title">' + e.title + '</h4><button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button></div>' : "", '<div class="modal-body">' + e.body + "</div>", e.footer ? '<div class="modal-footer"><button class="btn btn-subtle-secondary" type="button" data-bs-dismiss="modal">Cancel</button>' + e.footer + "</div>" : "", "</div>", "</div>", ].join(""))
            })
              , eI = ev('<div class="note-popover popover in"><div class="arrow"></div><div class="popover-content note-children-container"></div></div>', function(t, e) {
                var n = void 0 !== e.direction ? e.direction : "bottom";
                t.addClass(n),
                e.hideArrow && t.find(".arrow").hide()
            })
              , eP = ev('<div class="checkbox"></div>', function(t, e) {
                t.html(['<label class="hstack gap-3 align-items-center"' + (e.id ? ' for="note-' + e.id + '"' : "") + ">", '<input type="checkbox" class="form-check-input mt-0"' + (e.id ? ' id="note-' + e.id + '"' : ""), e.checked ? " checked" : "", ' aria-checked="' + (e.checked ? "true" : "false") + '"/>', e.text ? e.text : "", "</label>", ].join(""))
            })
              , e_ = function(t, e) {
                ...
                ui_template: function(t) {
                    return {
                        ...
                        palette: function(e, n) {
                            return ev('<div class="note-color-palette"></div>', function(e, n) {
                        ...
                        button: function(n, o) {
                            return ev('<button type="button" class="note-btn btn btn-default btn-sm" tabindex="-1"></button>', function(n, o) {
                                o && o.tooltip && n.attr({
                                    title: o.tooltip,
                        ...
                        createLayout: function(e) {
                            var n = (t.airMode ? ex([ey([ek(), e$()])]) : "bottom" === t.toolbarPosition ? eg([ey([ek(), eC()]), eb(), ew()]) : eg([eb(), ey([ek(), eC()]), ew()])).render();

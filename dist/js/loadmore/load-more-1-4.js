(function ($) {
    ...
    $.fn.loadMore = function (options) {
        ...
        let instance        = {
            ...
            eofCallback     : function () { return; },
            failCallback    : function (e) { return; },
            refreshParams   : function () { return; },
            params          : {}
        };
        ...
        if (typeof (options) === 'object') {
            ...
            loaderButton.off().click(function () {
                ...
                let foundSetting = settings.find(e => e.id == instance.id);
                if (foundSetting) {
                ...
                //Build querystring
                let queryString = buildQueryString(setting.params, page);
                ...
                $.ajax({
                    ...
                    statusCode  : {
                        404: function (response) {
                            setting.failCallback(response.responseText);
                        },
                        ...
                        200: function (response) {
                            ...
                            generateContentBody(loaderButton, setting);
    ...
    function buildQueryString(obj, counter) {
        let queryString = '';
        try {
            queryString = jQuery.param(obj);
        } catch (exception) {
            queryString = '';
        }

        queryString += `&page=${counter}`;

        return queryString;
    }

    function generateContentBody(button, setting) {
        ...
        if (html == '') {
            ...
            button.removeClass(setting.loaderClass);
            return;
        }
